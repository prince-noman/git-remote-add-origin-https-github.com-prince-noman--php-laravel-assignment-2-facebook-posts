								...
								<div class="card-body">
									<div class="post-header clearfix">
										...
										<div class="post-user-info">
											<h4><a href="#"><?php echo $person['name']?></a></h4>
											<p><?php echo $person['time']?><i class="fas fa-globe-americas"></i></p>
										</div>
										<a class="float-right" href="#"><i class="fas fa-ellipsis-h"></i></a>
									</div>
									<div class="post-content mt-2">
										<p><?php echo $person['content']?></p>
										<img src="<?php echo $person['featured_image']?>" alt="">
									</div>
									<hr>
									<div class="post-likes clearfix">
										<div class="like float-left">
											<img src="assets/media/img/post/like.svg" alt=""> <?php echo $person['like']?>
										</div>
										<div class="comment float-right">
										<?php echo $person['comment']?> comments 
										</div>
									</div>
									<hr>
